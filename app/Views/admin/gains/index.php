    ...
    <form action="/admin/gains" method="get">
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="date" name="date_debut" id="date_debut" value="<?= esc($date_debut ?? '') ?>">
            </div>
            <div class="form-group">
                <label for="date_fin">Date fin</label>
                <input type="date" name="date_fin" id="date_fin" value="<?= esc($date_fin ?? '') ?>">
            </div>
            <button type="submit" class="btn btn-primary">Filtrer</button>
            <a href="/admin/gains" class="btn btn-outline">Réinitialiser</a>
        </div>
    </form>
</div>
...
<div class="stats-grid">
    ...
    <div class="stat-card" style="border-top-color: #4361ee; grid-column: 1 / -1;">
