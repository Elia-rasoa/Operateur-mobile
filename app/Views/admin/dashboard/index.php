...
<div class="row g-3 mb-4">
    ...
    <div class="col-md-3 col-6">
        <div class="stat-card">
            ...
            <div class="stat-value"><?= number_format($soldeTotal, 0, ',', ' ') ?> FCFA</div>
        </div>
    </div>
    <div class="col-md-3 col-6">
        <div class="stat-card">
    ...
    <div class="col-md-3 col-6">
        <div class="stat-card">
            ...
            <div class="stat-value"><?= number_format($totalGains, 0, ',', ' ') ?> FCFA</div>
        </div>
    </div>
</div>
...
<h2 class="h4 fw-bold mb-3">Modules d'administration</h2>
<div class="modules">
    <a class="module" href="<?= site_url('admin/baremes') ?>">
        <span class="icon">📊</span>
        <span>
            <h3>Barèmes</h3>
            <p><?= esc((string) $totalBaremes) ?> tranche(s) tarifaire(s) configurée(s).</p>
        </span>
    ...
    <a class="module" href="<?= site_url('admin/prefixes') ?>">
        <span class="icon">📞</span>
        <span>
            <h3>Préfixes & Opérateurs</h3>
            <p><?= esc((string) $totalPrefixes) ?> opérateur(s) tiers enregistré(s).</p>
        </span>
        <span class="arrow">→</span>
    </a>
    <a class="module" href="<?= site_url('admin/transactions') ?>">
        ...
        <span>
            <h3>Transactions</h3>
            <p>Consulter les opérations, les filtres et les gains.</p>
        </span>
        <span class="arrow">→</span>
    </a>
    <a class="module" href="<?= site_url('admin/clients') ?>">
        ...
        <span>
            <h3>Clients</h3>
            <p>Consulter les soldes et l'historique de chaque client.</p>
        </span>
        <span class="arrow">→</span>
    </a>
    <a class="module" href="<?= site_url('admin/gains') ?>">
        ...
        <span>
            ...
            <p>Analyse détaillée : gains internes, externes et commissions d'interconnexion.</p>
        </span>
        <span class="arrow">→</span>
    </a>
    <a class="module" href="<?= site_url('admin/reversement') ?>">
        <span class="icon">🔄</span>
        <span>
            <h3>Récapitulatif reversement</h3>
            <p>Montants à reverser aux opérateurs tiers.</p>
        </span>
        <span class="arrow">→</span>
    </a>
</div>
