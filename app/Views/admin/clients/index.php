...
<body>
    <div class="container">
        ...
        <div style="margin-bottom: 20px;">
            <a href="<?= base_url('/') ?>" class="btn btn-details">← Retour vers le login</a>
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            <td>#<?= esc($c['id']) ?></td>
                            <td><a href="/admin/clients/historique/<?= esc($c['id']) ?>" class="phone-link"><?= esc($c['numero_telephone'] ?? $c['telephone'] ?? '-') ?></a></td>
                            <td><?= esc($c['nom'] ?? '-') ?></td>
